...
Type
 ...
 Size: LongInt;
 Public
 Function Crear(avTipoClave: TipoDatosClave; avTipoFuncionHash: TipoFuncionesHash; alSize: Lon
gInt; alNroPrimo: LongInt): Resultado;
 ...
 Function LLenarClavesRandom(alSize, alNroPrimo: LongInt; RangoDesde, RangoHasta: LongInt): Re
sultado;
...
// colisiones vacia
Function TablaHash.Crear(avTipoClave: TipoDatosClave; avTipoFuncionHash: TipoFuncionesHash; alSize:
LongInt; alNroPrimo: LongInt): Resultado;
Var I: LongInt;
Begin
