...
Begin
  ...
  Begin
    ...
    // La posicion 0 no la usamos pero hay que tenerla en cuenta
  ...
  Begin
    ...
    Begin
      ...
      If (P = Inicio) And (P = Final) Then
        Crear(TDatoDeLaClave, Size) // Unico de la lista. Se cre
...
Function Lista.LlenarClavesRandom(alSize: LongInt;
  RangoDesde, RangoHasta: LongInt): Resultado;
Var
  X: Tipoelemento;
Begin
