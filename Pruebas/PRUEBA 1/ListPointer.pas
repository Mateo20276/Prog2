...
Type
  ...
  Lista = Object
    Private // Comportamiento privado
    ...
    Public // Comportamiento del objeto (Operaciones del TAO)
...
Begin
  ...
  Else  Begin
    ...
    Q^.Ante := Final;
    If EsVacia Then
      Inicio := Q // Asigno como Primer elemento de la lista
...
Begin
  ...
  Else Begin
    ...
    Begin
      ...
      Q^.Ante := P^.Ante;
      If P = Inicio Then
        Inicio := Q // Caso que cambia el Inicio
      Else P^.Ante^.Prox := Q;
        P^.Ante := Q;
        Inc(Q_Items);
        Insertar := OK;
...
Begin
  ...
  Else Begin
    ...
    Q := P;
      ...
      Else Begin
        If (P = Inicio) Then        // Se elimina el primer elemento. Cambia el inicio
        Begin
          Inicio := Inicio^.Prox;
          Inicio^.Ante := NULO;
        End
        Else
          If (P = Final) Then       // Se elimina el ultimo elemento. Cambia el Final
          Begin
            Final := Final^.Ante;
            Final^.Prox := NULO;
          End
...
Function Lista.ordenarElementos: Lista;
begin
