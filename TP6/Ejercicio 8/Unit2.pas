...
campos: DNI, APELLIDO, NOMBRES, DOMICILIO, LOCALIDAD, TE y CELULAR. El archivo
se maneja a través de un índice (utilizando un árbol binario de búsqueda),
considerando como clave el campo DNI (el DNI es único, no existen duplicados).
Se deben mantener sincronizado el índice y el archivo, cada vez que se agrega o
elimina un registro en el archivo se debe actualizar el índice en memoria.}
